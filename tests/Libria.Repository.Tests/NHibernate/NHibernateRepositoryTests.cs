namespace Libria.Repository.Tests.NHibernate
{
	...
	public class NHibernateRepositoryTests: IClassFixture<PrepFixture>, IDisposable
	{
		private readonly PrepFixture _fixture;
		
		public NHibernateRepositoryTests(PrepFixture fixture)
		{
			_fixture = fixture;
		}
		...
		public void Given_An_Existing_Product_A_Cart_Must_Be_Added_With_One_Item()
		{
			...
			using (var uow = new TestNHibernateUnitOfWork())
			{
